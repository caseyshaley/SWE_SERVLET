...
private void PrintBody (PrintWriter out, String lhs, String rhs, String rslt)
{
   ...
   out.println("   <td><input type=\"text\" name=\"RHS\" value=\"" + rslt + "\" size=>");
   out.println("  </tr>");
   out.println(" </table>");
   out.println(" <br>");
   out.println(" <br>");
   out.println(" <input type=\"submit\" value=\"" + APlusB + "\" name=\"Operation\">");
   out.println(" <input type=\"submit\" value=\"" + BPlusA + "\" name=\"Operation\">");
